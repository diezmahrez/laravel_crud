<html> 
    ...
    <div class="card mt-2">
	  <div class="card-header bg-primary text-white text-center">Jadwal Kuliah</div>
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" name="kd_mkul" >
            </div>
            </div>
            <div class="row mb-3">
            <label for="kd_mkul" class="col-sm-2 col-form-label">Nama Mata Kuliah</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" name="nama_mkul" >
            </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="col-sm-10">
            <input type="date" id="datepicker" class="form-control" name="tanggal_mulai" >
            </div>
            </div>
            <div class="col-12">
